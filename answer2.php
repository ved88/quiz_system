...
<body>
  <center>
	<?php
		 ...
		 $wrong=0;
		 $no_answer=0;
         $query=mysqli_query($conn,"select id,ans from questions where cat_id='2'");
...
$w=  $array['no_answer'];
	...
	require 'PHPMailer/PHPMailerAutoload.php';
              ...
              $mail->Body="<b>hello</b>". $x ."<b>mail from online examination portal</b><br>"."<b>correct answer is:</b>".$y."<br><b>wrong answer is</b>".$z."<br><b>not attempted<b>".$w;
