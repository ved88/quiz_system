		...
		<form method="post" id="form1" action="answer.php">
		  <table class="table table-bordered">
			...
			<?php if(isset($row['ans1'])){?>
			  <tr class="info">
				<td>&nbsp;1&emsp;<input type="radio" value="1" name="<?php echo $row['id']; ?>" />&nbsp;<?php echo $row['ans1'];?> </td>
			  </tr>
			<?php }?>
			<?php if(isset($row['ans2'])){?>
			  <tr class="info">
				<td>&nbsp;2&emsp;<input type="radio" value="2" name="<?php echo $row['id']; ?>" />&nbsp;<?php echo $row['ans2'];?></td>
			  </tr>
			  <?php }?>
			  <?php if(isset($row['ans3'])){?>
			  <tr class="info">
				<td>&nbsp;3&emsp;<input type="radio" value="3" name="<?php echo $row['id']; ?>" />&nbsp;<?php echo $row['ans3'];?></td>
			  </tr>
			  <?php }?>
			  <?php if(isset($row['ans4'])){?>
			  	<tr class="info">
				<td>&nbsp;4&emsp;<input type="radio" value="4" name="<?php echo $row['id']; ?>" />&nbsp;<?php echo $row['ans4'];?></td>
			  </tr>
			  <?php }?>
			<tr class="info">
